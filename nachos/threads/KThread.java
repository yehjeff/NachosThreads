 ...
 * 
 * 
 * make sure joinee has been forked first? (i.e. status != statusNew)
 * added a static print method to print out whats in readyQueue 
 */
public class KThread {
	...
	public static void selfTest() {
		...
		System.out.println("Entering KThread.selfTest()");
		new KThread(new PingTest(1)).setName("forked thread").fork();
		new PingTest(0).run();
		
		System.out.println("\nTesting thread joins:");
		System.out.println("Thread 0 calls join on Thread 1");
		...
		System.out.println("\nTesting thread join again");
		System.out.println("Thread 0 calls join on Thread 1 when Thread 1 is finished");
		System.out.println("I DONT KNOW HOW TO TEST THIS YET");
		...
		System.out.println("\n Finished testing KThread.java\n");
		
	}
	
	public static void print(){
		//should assert interrupts are off?
